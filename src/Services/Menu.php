...
class Menu
{
     ...
     * 取得远程公众号的菜单.
     *
     * @param Modules\Weasy\Models\Accounts $account
     *
     * @return array 菜单信息
     */
    private function getFromRemote(Accounts $account)
    {
     ...
     * @return Response
     */
    public function syncToLocal(Accounts $account)
    {
     ...
     * @return array
     */
    private function resolveTextMenu(Accounts $account, $menu)
    {
        $menu['type'] = 'click';
