            ...
            <form class="form-horizontal" method="POST" action="{{ route('weasy.account.create') }}">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="name" name="name" class="form-control" id="name" value="{{ old('name') }}" placeholder="例如：weasy">
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" value="{{old('original_id')}}" placeholder="请认真填写，错了不能修改。例如gh_gks84hksi90o" name="original_id" type="text" id="original_id" />
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" value="{{old('wechat_account')}}" placeholder="例如：weasy" name="wechat_account" type="text" id="wechat_account" />
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" value="{{old('app_id')}}" placeholder="用于自定义菜单等高级功能" name="app_id" type="text" id="app_id" />
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" value="{{old('app_secret')}}" placeholder="用于自定义菜单等高级功能" name="app_secret" type="text" id="app_secret" />
